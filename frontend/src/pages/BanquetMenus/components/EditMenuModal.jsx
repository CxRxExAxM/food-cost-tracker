...
function EditMenuModal({ menu, onClose, onMenuUpdated, onMenuDeleted }) {
  const [formData, setFormData] = useState({
    ...
    min_guest_count: menu.min_guest_count || '',
    under_min_surcharge: menu.under_min_surcharge || '',
    target_food_cost_pct: menu.target_food_cost_pct || ''
  });
  ...
  const handleDelete = async () => {
    if (!confirm('Are you sure you want to delete this menu? All menu items and prep items will also be deleted.')) {
      return;
    }
