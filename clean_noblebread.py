...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python clean_noblebread.py <input_file> [output_csv_file]")
        print("\nSupported formats: .csv, .xlsx, .xls")
        print("Example: python clean_noblebread.py noblebread_data.xlsx cleaned_noblebread.csv")
        sys.exit(1)

    input_file = sys.argv[1]
    output_file = sys.argv[2] if len(sys.argv) > 2 else "cleaned_noblebread.csv"
